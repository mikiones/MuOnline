...
public class CA0Request implements ClientPackage {
	...
	public void process(byte[] data, ClientThread client) throws java.io.IOException {
//		final SSkillList _skilPack = new SSkillList();

		MuPcInstance cha = client.getActiveChar();
	 ...
	 * @param cha
	 */
	private static void setCharacterStats(SSelectedCharacterEnterAnsfer _characterStatsPack, MuPcInstance cha) {
	 ...
	 * @param cha
	 */
	private static void setLiveMaximals(SLiveStats _liveMaximalsPack, MuPcInstance cha) {
	 ...
	 * @param cha
	 */
	private static void setManaStaminaMaximals(SManaStaminaStats _manaStaminaMaximalsPack, MuPcInstance cha) {
